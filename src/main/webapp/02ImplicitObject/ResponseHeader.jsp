...
// 응답 헤더에 추가할 값 준비
/*
get 방식으로 전송된 폼값을 날짜형식을 통해 타입스템프로 변경한다.
getTime() : 날짜를 1970-01-01부터 지금까지의 시간을 초단위로 반환해주는 메서드
*/
// 날짜와 시간의 서식을 지정
SimpleDateFormat s = new SimpleDateFormat("yyyy-MM-dd HH:mm");
// String 타입의 폼값을 날짜형식으로 변경한 후 타임스템프를 얻어온다.
...
// 응답 헤더에 값 추가
/*
addDateHeader(헤더명, long타입의 타임스템스)
	: 응답헤더에 날짜형식을 추가하는 경우 long 타입의 타임스템프로 변환한 후 추가하면 된다.
addIntHeader()
	: 숫자형식의 응답헤더를 추가한다.
addHeader()
	: 문자형식의 응답헤더를 추가한다.
...
response.setHeader("myName", "안중근"); // 변경
%>
