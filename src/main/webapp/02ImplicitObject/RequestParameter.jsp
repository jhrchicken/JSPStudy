...
<%
/*
Tomcat 9.x 버전에서는 post 방식으로 한글을 전송하는 경우 깨짐현상이 발생되므로 아래와 같이 인코딩 처리를 해야한다.
10.x에서는 깨짐현상이 없으므로 사용하지 않아도 된다.
*/
...
getParameter()
	...
	: 입력값이 문자, 숫자에 상관없이 String 타입으로 저장된.
getParameterValues()
...
따라서 웹브라우저에 출력할 때는 <br> 태그로 변경해야한다.
*/
