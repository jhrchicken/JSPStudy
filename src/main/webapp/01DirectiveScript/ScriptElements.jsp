...
/*
스크립트렛(Scriptlet)
: 주로 JSP코드를 작성하고 실행할 때 사용한다. 스크립트렛은 <body>, <head> 어디서든 사옹할 수 있다.
...
<!--
표현식(Expression)
: 변수를 웹브라우저상에 출력할 때 사용한다. JS의 document.write()와 동일하다.
...
<%
	/* JSP에서 선언부는 빈번하게 사용되지 않는다. 주로 Java로 클래스를 만든 후 아래와 같이 사용하는 경우가 더 많다. */
