...
<body>
	...
	<!-- EL에서는 + 연산자로 덧셈 기능만 수행할 수 있다. 문자열의 연결에는 사용되지 않는다. -->
    <h3>+ 연산자는 덧셈만 가능</h3>
    <!-- 문자열 34가 자동으로 정수로 변경되어 연산된다. Integer.parseInt()를 적용한 것과 동일한 결과가 반환된다. -->
    num1 + "34" : ${ num1 + "34" } <br/>
	...
	<!-- 논리And, 논리Or 사용 시 && / || 대신 영문자 형식의 연산자를 사용할 수 있다. -->
    <h3>논리 연산자</h3>
