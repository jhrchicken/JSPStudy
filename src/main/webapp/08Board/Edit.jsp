...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!-- 수정페이지로 진입 시 로그인을 확인한다. -->
<%@ include file="./IsLoggedIn.jsp"%>

<%
/* 수정은 기본적으로 내용보기와 로직이 동일하다. 기존의 내용을 인출한 후 작성폼에 설정해야 하기 때문이다.
...
세션영역에 저장된 회원 아이디를 가져와서 문자열로 변경한 후 게시물의 작성자와 일치하는지 확인한다. */
...
<body>
	...
	<!-- 수정페이지는 일반적으로 쓰기 페에지를 복사해서 제작하게 되므로 action의 속성값을 반드시 수정해야 한다. -->
	<form name="writeFrm" method="post" action="EditProcess.jsp"
		onsubmit="return validateForm(this);">
		<!-- 게시물의 일련번호를 서버로 전송하기 위해 hidden 타입의 입력상자를 반드시 추가해야 한다.
		...
		<table border="1" width="90%">
			...
			<tr>
				<td>내용</td>
				<!-- textarea는 value 속성이 없기 때문에 다음과 같이 작성한다. -->
